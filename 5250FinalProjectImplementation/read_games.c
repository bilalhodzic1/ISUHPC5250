 ...
 *
 * @param string_array An array of strings representing the fields of the game data.
...
game_t parse_game_line(char** string_array){
    ...
    game.team_abbreviation = string_array[4];
 ...
 * @param num_games A pointer to an integer that will be set to the number of games read.
